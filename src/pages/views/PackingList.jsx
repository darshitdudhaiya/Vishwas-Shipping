...
import { packings } from "../../settings/consts";
import { useNavigate } from "react-router-dom";
import PackingDetailModal from "../../common/models/PackingDetailsModal";


const PackingList = ({ handleCurrentWindow }) => {
  ...
  useEffect(() => {
    handleCurrentWindow("Packing List");
  }, []);
  ...
  return (
    <div className="px-3">
      ...
      />
      <PackingDetailModal userModalOpen={userModalOpen} setUserModalOpen={setUserModalOpen} packing={packing}/>
    </div>
  );
};
