...
import { deliveries } from "../../settings/consts";
import { useNavigate } from "react-router-dom";
import DeliveryDetailModal from "../../common/models/DeliveryDetailsModal";


const DeliveryList = ({ handleCurrentWindow }) => {
  ...
  useEffect(() => {
    handleCurrentWindow("Delivery List");
  }, []);
  ...
  return (
    <div className="px-3">
      ...
      />
      <DeliveryDetailModal userModalOpen={userModalOpen} setUserModalOpen={setUserModalOpen} delivery={delivery}/>
    </div>
  );
};
