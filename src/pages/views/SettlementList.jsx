...
import { settlements } from "../../settings/consts";
import { useNavigate } from "react-router-dom";
import SettlementDetailModal from "../../common/models/SettlementDetailModal";


const SettlementList = ({ handleCurrentWindow }) => {
  ...
  useEffect(() => {
    handleCurrentWindow("Settlement List");
  }, []);
  ...
  return (
    <div className="px-3">
                  ...
                  {settlements.map((settlement) => {
                    return (
                      <tr key={settlement.id}>
                        ...
                        <td>{settlement.caseno}</td>
                        <td>{settlement.cname}</td>
                        <td>{settlement.empname}</td>
                        <td>{settlement.loc}</td>
      ...
      />
      <SettlementDetailModal userModalOpen={userModalOpen} setUserModalOpen={setUserModalOpen} settlement={settlement}/>
    </div>
  );
};
